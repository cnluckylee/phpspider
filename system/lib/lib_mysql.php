...
class Mysql
{
    ...
    function init($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf-8', $pconnect = 0, $quiet = 1)
    {
        ...
        if ($quiet)
        {
           return  $this->connect($dbhost, $dbuser, $dbpw, $dbname, $charset, $pconnect, $quiet);
        }
        else
        {
            $this->settings = array(
